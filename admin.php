...
if(isset($_POST['bsimpan'])) {
    ...
    $sql = "INSERT INTO ttamu (tanggal, nama, alamat, tujuan, nope) VALUES ('$tgl' ,'$nama' ,'$alamat' ,'$tujuan' ,'$nope')";
    ...
    if ($simpan) {
        ...
        echo "<script>alert('Simpen Data GAGAL!!!');
        document.location='?'</script>";
    }
}
 ...
 ?>
    ...
    <div class="head text-center">
        <img src="assets/img/logo.png" style="width:130px;height:130px;">
        <h2 class="text-white">Buku Tamu Smk Negeri 69 Jakarta <br> Sistem Informasi</h2>
    </div>
     <!-- end Head -->
        ...
        <div class="col-lg-7 mb-3">
            <div class="card shadow bg-gradient-light">
                ...
                <div class="card-body">
                            ...
                            <hr>
                            <div class="text-center">
                                <a class="small" href="#">By. NaAuFeSha || 2022 - <?=date('Y')?></a>
                            </div>
                   </div>
                 <!-- end card-body -->
            </div>
     ...
     <!-- end row-->
      ...
      <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <a href="logout.php" class="btn btn-danger mb-3"><i class="fa fa-z"></i> Logout</a>
